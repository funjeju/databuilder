...
export const TARGET_AUDIENCE_OPTIONS = ["누구나", "가족", "아이", "연인", "친구", "나홀로", "부모님"];
export const RECOMMENDED_SEASONS_OPTIONS = ["아무때나", "봄", "여름", "가을", "겨울"];
...
export const COMMENT_TYPE_OPTIONS = ["특징", "배경", "꿀팁", "주의사항", "전문가평가"];
